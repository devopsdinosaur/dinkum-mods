...
public class Settings {
    ...
    public static ConfigEntry<string> m_match_words;
    ...
    public void load(DDPlugin plugin) {
        ...
        m_match_words = this.m_plugin.Config.Bind<string>("General", "Tool Word Matches", "Axe,Chainsaw,Compactor,Scythe,Shovel", "If tool/weapon name contains any of these words it will be considered valid for hitting plants; separate by commas, case sensitive, no spaces!");
    }
}